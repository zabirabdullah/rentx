...
const dummyProperties = [
  ...
  { 
    ...
    image: 'https://lh3.googleusercontent.com/aida-public/AB6AXuB3f6GlgrcIQGBCSYszL5wJE5ktXof4kVlsq1wvFlxAM3oHPZ5Q_gXb6iPC3qtTj37O6w6NF_wTnKMy6goCJgQo4feeV5OjMzvotb1-Zs6fIvbwpKmo_6F2mPbZhQBigwfEeQocdpODSVsvi6SnnO92OMzcRF1z3XHEc2iaPFHKtzmNPQSC1xqzTxzuRfzwbx6j0Pf0uPiJYCQItp20HoS1r6bz4ZAK1F_LLg9nzjTG3eewHCeaZVXTjYv_8W__GkayAScFcBvshwQ' 
  },
  { 
    id: 3, 
    title: 'The Terrace Executive', 
    price: '165k', 
    position: [23.7940, 90.4000] as [number, number], 
    beds: 4, 
    baths: 4, 
    sqft: 2800, 
    location: 'Banani Block H',
    image: 'https://lh3.googleusercontent.com/aida-public/AB6AXuC1CnRHHNTrsAFfL7_QteYZohG6QJmAMDz0_DBLhrAKv7gUYj1hAJxBvr84OnCMeujhCTsL1EnHZoD9ms-I18mU1puDM2oKw-xfxb7KZY6OgV-ude2MgHOxJXy36c4QnMK0-25eugqMQUz8PQg80kXTxfO6J9j8QWw9RK_8IkcgT0IjfRepxVVbmvEYg5DZC8RPV8POxswc0VX8xe0ia8OdFsQ7LXZifUIT3ujkp8EUwWDBgM3ycwd4aJebZxan_zDmkkkJS7VqBdI' 
  },
  {
    id: 4,
    title: 'Diplomatic Enclave Villa',
    price: '350k',
    position: [23.8005, 90.4150] as [number, number], // Approx Baridhara
    beds: 5,
    baths: 5,
    sqft: 5500,
    location: 'Baridhara',
    image: 'https://lh3.googleusercontent.com/aida-public/AB6AXuDBduh4YIXNE82_qZihm0HbAc5EKvvQQTT2nQoYxq6TOtjMhJ09VHCaBNVFb8uxjssAmb74mVbzsVKS8kuFeHPWNkJudgb_3FWxOcSPlG5D8tbGOJAyIOdxqYpuu2kV8-GgWQEVdTpaggUymXgFqVmqWzYqEA04c406XD00AXVhGYpsVy03SpiDlyL1Nzn5M72j__L8sljK3TL-o4McCZ0_L1hqp6SntO86D05OT2UY5MCcJsiw2_d5TFabj_CP-MbZoDAMakAhunM'
  }
];

export function LiveAvailabilityMap() {
  const [isMounted, setIsMounted] = useState(false);
  const [activeProperty, setActiveProperty] = useState<typeof dummyProperties[0] | null>(null);
  ...
  return (
    <section className="py-section-padding px-8 max-w-7xl mx-auto">
      <div className="flex justify-between items-end mb-12">
        <div>
          <h2 className="font-headline-xl text-headline-xl text-on-surface mb-2">Live Availability Map</h2>
          <p className="text-on-surface-variant font-body-md">Explore available properties interactively across Dhaka.</p>
        </div>
      </div>
          ...
          <div className="absolute bottom-6 left-6 right-6 md:left-auto md:right-6 md:w-80 bg-white/80 backdrop-blur-md rounded-2xl p-4 shadow-[0_10px_30px_rgba(0,0,0,0.1)] border border-white/50 z-10 transition-all animate-in fade-in slide-in-from-bottom-4">
            ...
            <div className="flex gap-4 items-center">
              ...
              <div className="flex-1">
                <p className="text-[10px] font-bold text-emerald-600 uppercase tracking-wider mb-0.5">{activeProperty.location}</p>
                <h4 className="font-bold text-slate-900 text-sm mb-1 leading-tight">{activeProperty.title}</h4>
                <p className="text-xs text-slate-500">{activeProperty.beds} Bed • {activeProperty.baths} Bath</p>
                <p className="text-sm font-black text-slate-900 mt-1">৳{activeProperty.price}</p>
              </div>
            </div>

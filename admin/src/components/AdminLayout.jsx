          ...
          <div className="flex items-center gap-4">
            ...
            <div className="flex items-center gap-3 pl-4 border-l border-slate-200">
              ...
              <div className="hidden sm:block">
                ...
                <p className="text-xs text-slate-400">admin@rentx.com</p>
              </div>
              <button className="ml-2 flex items-center gap-1 text-sm text-red-500 hover:text-red-700 font-medium transition-colors">
